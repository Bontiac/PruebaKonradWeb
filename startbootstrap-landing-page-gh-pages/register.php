    ...
    <div class="container">
        ...
        <div class="card bg-light">
            ...
            <article class="card-body mx-auto" style="max-width: 400px;">
                <h4 class="card-title mt-3 text-center" class="card-title mt-3 text-center">
                    <img src="img/k.png" style="height: 50px;">
                </h4>
                ...
                <form>
                    ...
                    <div class="form-group input-group">
                        ...
                        <input class="form-control" placeholder="Crea tu password" type="password">
                    </div>
                    <!-- form-group// -->
                    <div class="form-group input-group">
                        <div class="input-group-prepend">
                        ...
                        <input class="form-control" placeholder="repite tu password" type="password">
                    </div>
                    <!-- form-group// -->
